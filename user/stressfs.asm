...
main(int argc, char *argv[])
{
  ...
  1a:	8ea78793          	addi	a5,a5,-1814 # 900 <malloc+0x13e>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8a450513          	addi	a0,a0,-1884 # 8d0 <malloc+0x10e>
  ...
  6c:	88050513          	addi	a0,a0,-1920 # 8e8 <malloc+0x126>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	84250513          	addi	a0,a0,-1982 # 8f8 <malloc+0x136>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 486:	4ee50513          	addi	a0,a0,1262 # 970 <digits>
 48a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58c:	39070713          	addi	a4,a4,912 # 918 <malloc+0x156>
 ...
 618:	35cb8b93          	addi	s7,s7,860 # 970 <digits>
 ...
 66e:	2a690913          	addi	s2,s2,678 # 910 <malloc+0x14e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74e:	c967b783          	ld	a5,-874(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 7e2:	c0253503          	ld	a0,-1022(a0) # 13e0 <freep>
 ...
 812:	bd290913          	addi	s2,s2,-1070 # 13e0 <freep>
  if(p == (char*)-1)
 816:	5afd                	li	s5,-1
 ...
 826:	bce78793          	addi	a5,a5,-1074 # 13f0 <base>
 82a:	00001717          	auipc	a4,0x1
 82e:	baf73b23          	sd	a5,-1098(a4) # 13e0 <freep>
 832:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8a4:	b4a73023          	sd	a0,-1216(a4) # 13e0 <freep>
      return (void*)(p + 1);
